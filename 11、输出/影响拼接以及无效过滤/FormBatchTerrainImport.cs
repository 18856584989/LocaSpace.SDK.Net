...
namespace WorldGIS
{
    public partial class FormBatchTerrainImport : Form
    {
        ...
        private void checkBox_polygonRestricted_CheckedChanged(object sender, EventArgs e)
        {
            panel_PolygonRestric.Enabled = !panel_PolygonRestric.Enabled;
        }

        private void checkBox_MulThread_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void button_OK_Click(object sender, EventArgs e)
        {
            ...
            //0：处理影像   1：处理地形
            rasterImporter.ImportType(Enum_ImportType.IT_Terrain);
            //无效值过滤
        ...
        private void UpdateProgress(int v)
        {
            ...
            //改变任务栏进度条
            taskbarManager.SetProgressValue(subCurrentValue, 100);
            //改变标题
            this.Text = $"{subCurrentValue}% ({indexFile / dt.Rows.Count})- {defTitle}";
        }

        private void FormBatchTerrainImport_Load(object sender, EventArgs e)
        {
            panel_PolygonRestric.Enabled = false;
            panel_NoValue.Enabled = false;
        ...
        private void FormBatchTerrainImport_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (workThread != null)
            {
                workThread.Abort();
